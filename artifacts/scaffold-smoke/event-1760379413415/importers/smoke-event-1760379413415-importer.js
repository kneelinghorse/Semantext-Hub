...
export class SmokeEVENT1760379413415Importer {
  ...
  async import(source) {
    ...
    return {
      type: 'event',
      name: 'Smoke_EVENT_1760379413415',
      version: '1.0.0',
      protocol: {},
      metadata: {
...
export default SmokeEVENT1760379413415Importer;
