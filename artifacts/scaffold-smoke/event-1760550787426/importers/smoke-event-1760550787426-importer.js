...
export class SmokeEVENT1760550787426Importer {
  ...
  async import(source) {
    ...
    return {
      type: 'event',
      name: 'Smoke_EVENT_1760550787426',
      version: '1.0.0',
      protocol: {},
      metadata: {
...
export default SmokeEVENT1760550787426Importer;
