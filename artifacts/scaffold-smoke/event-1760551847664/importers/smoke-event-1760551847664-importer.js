...
export class SmokeEVENT1760551847664Importer {
  ...
  async import(source) {
    ...
    return {
      type: 'event',
      name: 'Smoke_EVENT_1760551847664',
      version: '1.0.0',
      protocol: {},
      metadata: {
...
export default SmokeEVENT1760551847664Importer;
