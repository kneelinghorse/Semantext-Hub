...
export class SmokeEVENT1760756868758Importer {
  ...
  async import(source) {
    ...
    return {
      type: 'event',
      name: 'Smoke_EVENT_1760756868758',
      version: '1.0.0',
      protocol: {},
      metadata: {
...
export default SmokeEVENT1760756868758Importer;
