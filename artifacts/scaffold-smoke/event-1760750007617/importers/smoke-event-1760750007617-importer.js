...
export class SmokeEVENT1760750007617Importer {
  ...
  async import(source) {
    ...
    return {
      type: 'event',
      name: 'Smoke_EVENT_1760750007617',
      version: '1.0.0',
      protocol: {},
      metadata: {
...
export default SmokeEVENT1760750007617Importer;
