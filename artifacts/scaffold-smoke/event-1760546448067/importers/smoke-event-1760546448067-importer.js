...
export class SmokeEVENT1760546448067Importer {
  ...
  async import(source) {
    ...
    return {
      type: 'event',
      name: 'Smoke_EVENT_1760546448067',
      version: '1.0.0',
      protocol: {},
      metadata: {
...
export default SmokeEVENT1760546448067Importer;
