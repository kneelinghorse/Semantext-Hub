...
export class SmokeEVENT1760322530163Importer {
  ...
  async import(source) {
    ...
    return {
      type: 'event',
      name: 'Smoke_EVENT_1760322530163',
      version: '1.0.0',
      protocol: {},
      metadata: {
...
export default SmokeEVENT1760322530163Importer;
